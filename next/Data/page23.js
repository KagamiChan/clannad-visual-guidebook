...
CmtSelect =
  '选择[赶路要紧]，则完全进入渚线；选择[问问看他们]，则完全进入风子线，但不能达成风子TRUE ENDING。进入渚线后，可以选择攻略古河渚或者幸村俊夫。古河渚/幸村俊夫角色剧情攻略请参见P51～P55；伊吹风子角色剧情攻略请参见P43～P45。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
CmtSelect =
  '若24日在分支{朋也面对哭泣的渚}选择[就这样注视着她]，满足18日在分支{独自雕刻的风子}选择了[再看一会儿]的条件，同样会出现这个场景，但剧情和选项均有变化。选择[问问看他们]，则可完全进入风子线，并有机会达成风子TRUE ENDING或者风子GOOD ENDING，否则进入渚BAD ENDING。伊吹风子角色剧情攻略请参见P43～P45。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[15][2] = Textbox_Selection_C(
  x(4),
  y(yLevel),
  '男生们关于幽灵的话题（二）',
  '2',
