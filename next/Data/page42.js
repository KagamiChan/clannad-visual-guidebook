...
CmtSummery = ''
CmtSelect =
  '琴美线中一共有7次提升好感度的机会：15日或16日，在分支{图书馆，被奇怪的女孩邀请吃便当}选择[吃]（两次只能触发一次）；19日，分支{发现琴美进入书店}选择[跟在她后面进入书店]，分支{和琴美离开书店}选择[提出送她回家]；20日，分支{读书的邀请}选择[读书]；21日，分支{介意的琴美}选择[稍稍逗她玩一下]；29日，分支{假日中的安排}选择[外出]；今日，分支{两个人的假日}选择[告白]。<br>此处实际参与判定的只有6次，即除了最后一次以外，抓住了所有提升好感度的机会的话，就不会出现下面可能导致BAD ENDING的分支。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[3][0] = Textbox_Condition_C(
  x(3),
  y(yLevel),
  '好感度大于5',
  '2',
