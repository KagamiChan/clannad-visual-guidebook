...
yLevel+=2;
CmtSummery="";
CmtSelect="本日，若选择[把风子带到别处去]或[找别人装扮自己]，会跳回重新作选择，这两项恶作剧本日无法完成。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[4][0]=Textbox_Selection_C(x(0.5),y(yLevel),"风子恶作剧（六）","5",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"风子恶作剧（六）",0);
...
yLevel+=2;
CmtSummery="";
CmtSelect="本日，若选择[找别人来装扮自己]，会跳回重新作选择，这项恶作剧本日无法完成。本日可选特殊恶作剧[给风子吃早苗的面包]，完成一次即可达到“登峰造极”。若24日在分支{风子陷入幻想（四）}选择[不去管她]或者未触发这个分支，直接进入[给风子吃早苗的面包]剧情。<br>本日，[把风子带到别处去]不论是否已经达成，选择后发生在秋生的房间的剧情。（即如果已完成，选择后不会跳回重新作选择）<br>如果4项常规恶作剧全部达成，则成为“风子大师”。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[14][0]=Textbox_Selection_C(x(0.5),y(yLevel),"风子恶作剧（七）","6",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"风子恶作剧（七）",0);
...
CmtSummery="";
CmtSelect="4项常规恶作剧：[让风子用鼻子喝果汁]、[把风子带到别处去]、[找别人来装扮自己]、[偷换掉风子怀里的雕刻]，全部达到“登峰造极”（MAX等级）后（即成为“风子大师”），30日在分支{累了的风子}选择[揉鼻子]，触发最后的隐藏恶作剧剧情，成为“风子召唤使”。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[20][1]=Textbox_Condition_C(x(3),y(yLevel),"4项常规恶作剧全部达成","7",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"4项常规恶作剧全部达成",0);
