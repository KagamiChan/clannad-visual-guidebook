...
CmtSelect =
  '选择[真的？真的可以吗？]，则完全进入杏、椋线。藤林杏、藤林椋角色剧情攻略请参见P34～P36。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
yLevel += 2
CmtSummery =
  '昨晚与朋也在电话中的聊天让芽衣决定前来宿舍探望自己的哥哥。春原不想让妹妹看到自己颓废的样子。'
...
CmtSummery = ''
CmtSelect =
  '{21日或22日，春原认识有纪宁}即在没有{进入渚、风子线}（具体请参见公共线路22日注释1）和{18日或19日，在资料室认识有纪宁}（具体请参见公共线路22日注释4）的前提下，如果在20日的分支{芳野寻求帮手}中选择[拒绝]或者未触发这个分支，则21日午后会触发一段没有分支的有纪宁的剧情，在此春原认识了有纪宁，并且22日午后可触发另一段有分支的有纪宁剧情。如果20日的分支中选择了[帮助]，并且在22日的分支{回答智代的询问}中选择[添麻烦了]或者未触发这个分支，那么21日春原认识有纪宁的剧情会延迟到22日发生，22日本来的剧情被替代（参考公共线路22日注释4）；如果在分支{回答智代的询问}中选择选择[不，不是这个意思]，则春原不会认识有纪宁。<br>只要触发了这段春原认识了有纪宁的剧情，就符合是的条件。（同公共线路23日注释3）<br>宫泽有纪宁角色剧情攻略请参见P31。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
