...
CmtSelect =
  '选择[道歉]，则进入藤林姐妹的线路，但17日逃课后不会触发一之濑琴美的剧情而无法继续琴美线。因此，攻略琴美线时须选择[无视]。'
CmtCaution =
  '在CLANNAD中，选择分支每个选项都会对日后剧情的内容产生不同的影响，但不一定都改变剧情的走向。'
CmtOption = '-无视'
CmtEvents = '00100000'
...
CmtSelect =
  '选择[逃课]，则15日顺利进入一之濑琴美的剧情；若选择[认认真真上课]，则16日还有最后一次认识琴美的机会。15日逃课后，16日的机会就会消失，简而言之，两次机会您只能把握一次。若在之前的分支{面对泪水打转的椋}选择[道歉]，17日即强制退出琴美线。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[3][0] = Textbox_Selection_C(
  x(3.5),
  y(yLevel),
  '上午、英语语法课',
  '2',
...
CmtSelect = ''
CmtCaution =
  '琴美线是CLANNAD中唯一有好感度系统的线路。请注意不要让好感度过低，否则后续剧情会增加一些可能导致BAD ENDING的选择分支。每次选择了正确的选项之后都能使好感度上升1点。'
CmtOption = '-吃'
CmtEvents = '00000100'
...
yLevel += 4
CmtSummery =
  '午休时间，朋也在走廊上，看到庭院中独自一人坐着的少女。没错，就是连续两天在坡道上遇见的那个女孩。孤单的她好像并没有朋友的陪伴……'
CmtSelect =
  '选择[到庭院去]并且接下来的分支选择[再继续谈话]，则进入古河渚和伊吹风子的线路，同时这又是琴美线的必选项和能够达成智代线GOOD ENDING的必要前提。'
CmtCaution =
  'CLANNAD中，渚线和风子线在公共剧情中重叠部分相对各自与其它线路之间要多很多。它们是关系比较紧密的两条线。除此之外，还有藤林姐妹线和柊胜平线；坂上智代线和相乐美佐枝线。'
CmtOption = '+到庭院去|-再继续谈话'
CmtEvents = '11010000'
CmtEvntIru =
  '渚有条件参与64HIT、有纪宁的咒语、体育仓库事件和伪女友事件；秋生有条件参与体育仓库事件。'
...
yLevel += 4
CmtSummery =
  '下午，校门口传来嘈杂声，是工业学校的学生的上门挑衅。此时，一位银发女生在众人的注视下出场了，并在片刻间平息了骚动。好事的春原决定会她一会……'
CmtSelect =
  '选择[继续看下去]并在接下来的分支选择[我也对此颇感兴趣]，则进入坂上智代线。若在之前的分支{中午、庭院中的少女}选择[不去管她]，之后将无法达成智代线GOOD ENDING。'
CmtCaution = ''
CmtOption = '+继续看下去|-我对此也颇感兴趣'
CmtEvents = '01110011'
CmtEvntIru =
  '智代有条件参与有纪宁的咒语、体育仓库事件、3对3篮球赛、伪女友事件和毕业典礼；业余棒球进入必选'
...
CmtSelect = ''
CmtCaution =
  '这是游戏中第一次遇到条件选择分支的地方。大多数情况下，我们以是否进入某条线路作为判断条件。CLANNAD中，这种情况是很普遍的。但在某些情况下，只能用特定日期的特定选择来表述。您在攻略时，应当注意每个选择项旁所给出的角标提示，并作适当记录，来确定目前处于哪些角色的线路之中以防止出错。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[15][0] = Textbox_Condition_C(
  x(3.5),
  y(yLevel),
  '中午，庭院中与少女的谈话',
  '6',
...
yLevel += 4
CmtSummery =
  '放学后照例来到春原宿舍楼的朋也，在走廊上遇到了正追赶捣乱学生的宿舍管理员——相乐美佐枝。'
CmtSelect = '选择[向她搭话]，则进入相乐美佐枝线。'
CmtCaution = ''
CmtOption = '-向她搭话'
CmtEvents = '01100001'
CmtEvntIru = '美佐枝有条件参与有纪宁的咒语、3对3篮球赛和毕业典礼。'
box[19][0] = Textbox_Selection_C(
  x(3.5),
  y(yLevel),
  '宿舍走廊遇见美佐枝',
  '8',
...
CmtSelect = ''
CmtCaution =
  '在CLANNAD中，幻想世界是一部分特殊的剧情。幻想世界体现了CLANNAD的背景世界观，是有别于游戏中现实世界的另一个世界，且与渚线路有紧密的联系。幻想世界全篇共十二章，其中在学园篇最多出现十章，后两章将在AFTER STORY中，其作用将在AFTER STORY时得到体现。只有在攻略渚线时，您才能看到完整的幻想世界学园篇部分。幻想世界中没有选择分支。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[21][0] = Textbox_Option_C(
  x(3.5),
  y(yLevel),
  '幻想世界（一）',
  '9',
