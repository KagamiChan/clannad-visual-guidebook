...
CmtSummery = ''
CmtSelect =
  '{18日，和琴美一起吃午饭}包括18日，在分支{琴美的邀请与古河的约定}选择[在这里和琴美一起吃]；或者虽然没有出现这个分支，但是发生了和琴美一起吃午饭的剧情内容（18日渚、风子线未进入，即16日在分支{古河重新创立话剧社}选择[让她一个人做]或者未触发这个分支的话，在分支{寻找春原}和{朋也内心的思索}分别选择[图书馆]和[不能就这样不理她]，就会发生和琴美一起吃午饭的剧情内容）。不符合以上条件的情况均属于否。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[10][0] = Textbox_Condition_C(
  x(3),
  y(yLevel),
  '18日，和琴美一起吃午饭',
  '3',
