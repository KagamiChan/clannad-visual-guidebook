...
CmtSelect="此处连续三个分支，一共有五个不同的选择项：[严厉]、[战斗力很高]、[温柔]、[为我操心]、[被窝中的味道很香]。与图中流程的表达不同的是，在{喜欢美佐枝的理由（一）}和{喜欢美佐枝的理由（一）}选择了[战斗力很高]或[温柔]，接下来的分支都会出现而不是直接Bad Ending。在下一个分支中，上一次选择了的选项将被[为我操心]、[被窝中的味道很香]依次替代。三个分支只有按顺序选择[严厉]、[为我操心]、[被窝中的味道很香]才能达成美佐枝Good Ending，否则，将在三个分支结束后，进入Bad Ending。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[1][0]=Textbox_Selection_C(x(3),y(yLevel),"喜欢美佐枝的理由（一）","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"喜欢美佐枝的理由（一）～（三）",0);
