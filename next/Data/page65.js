...
hdft['header'] = Header(
  ...
  'After Story',
  '同栖篇（二）',
  'Chapter of Conhabitation Life~Part 2',
)
...
line[line.length] = Link(
  box[10][0],
  Point(linx(2.5), liny(-1)),
  Point(linx(1.5), liny(-2)),
  box[9][0],
)
line[line.length] = Link(
  box[10][0],
...
line[line.length] = Link(
  Point(linx(1.5), liny(3)),
  Point(linx(3.5), liny(3)),
  Point(linx(3.5), liny(-2)),
  box[20][1],
)
line[line.length] = Link(
  Point(linx(1.5), liny(3)),
  Point(linx(3.5), liny(3)),
  Point(linx(3.5), liny(-7)),
  box[18][1],
)
line[line.length] = Link(
  Point(linx(1.5), liny(3)),
  Point(linx(3.5), liny(3)),
  Point(linx(3.5), liny(-12)),
  box[16][1],
)
line[line.length] = Link(
  Point(linx(1.5), liny(3)),
  Point(linx(3.5), liny(3)),
  Point(linx(3.5), liny(-14)),
  box[14][1],
)
line[line.length] = Link(
  Point(linx(1.5), liny(3)),
  Point(linx(3.5), liny(3)),
  Point(linx(3.5), liny(-17)),
  box[14][2],
)
