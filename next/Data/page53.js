...
CmtSummery = ''
CmtSelect =
  '{风子“光”消失事件触发条件}包括完成过风子线（达成风子TRUE ENDING或者风子GOOD ENDING）并且至少获得一颗“光”，以及之前没有触发过风子“光”消失事件（即该事件只能触发一次）。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
CmtSelect = ''
CmtCaution =
  '古河渚线中期特殊事件。发生于29日下午，对AFTER STORY产生重大影响。用得到的一颗“光”为沉睡中风子许愿，“光”的数量会减少1，并且是AFTER STORY中获得风子和公子的“光”，从而达成TRUE ENDING的必要条件。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[7][1] = Textbox_Option_C(
  x(6),
  y(yLevel),
  '风子“光”消失事件',
  '2',
...
CmtSummery = ''
CmtSelect =
  '{篮球赛可以获胜的条件}即3对3篮球赛（一）和（二）中邀请到杏、智代、美佐枝、秋生、芳野当中的一位成为参赛伙伴。3对3篮球赛相关攻略请参见P56～P58。<br>邀请到杏为参赛伙伴后，接下来的分支{最后一球的配合}出现的选项为[最后一球给我]和[最后一球给杏]，[最后一球给我]总是不变的而另一个选项因具体参赛伙伴而不同（[最后一球给智代/美佐枝/大叔/芳野先生]）。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
CmtSummery = ''
CmtSelect =
  '{29日，在古河面包店遇见公子}包括26日，在分支{前来探亲的芽衣}选择[好的]；27日，在分支{帮忙打理店铺}选择[可以]以及在29日的分支{明天的计划安排}中选择[让她和芽衣玩]或者未触发这个分支，就能在29日下午的古河面包店遇见公子。也可以在{前来探亲的芽衣}选择[自己一个人去吧]或者未触发这个分支，并且在28日的分支{面对练习的想法}中选择[想对策]，同符合是的条件。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[20][0] = Textbox_Condition_C(
  x(4.5),
  y(yLevel),
  '29日，古河面包店前遇见公子',
  '2',
