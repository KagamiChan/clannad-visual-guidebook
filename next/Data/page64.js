...
hdft['header'] = Header(
  ...
  'After Story',
  '同栖篇（一）',
  'Chapter of Conhabitation Life~Part 1',
)
...
CmtSelect = ''
CmtCaution =
  'AFTER STORY继承古河渚学院篇线路的分支选择记录继续游戏,因此,在AFTER STORY中牵涉到学院篇的选择分支,都是最近一次完成渚线并保存记录的过程中,在相应分支做出的选择来判断的.'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[8][2] = Textbox_Condition_C(
  x(4),
  y(yLevel),
  '学院篇2日,对待早苗的心情',
  '1',
...
CmtEvents = '00000001'
CmtEvntIru =
  '公子有条件参与毕业典礼。如果学园篇29日满足在古河面包店前遇见公子，则公子已确定出席毕业典礼，此处的选择没有影响'
...
CmtEvents = '00000001'
CmtEvntIru =
  '公子参与毕业典礼。如果学园篇29日满足在古河面包店前遇见公子，则公子已确定出席毕业典礼，此处的选择没有影响'
box[21][0] = Textbox_Selection_C(
  x(1),
  y(yLevel),
  '探望伊吹老师',
  '3',
