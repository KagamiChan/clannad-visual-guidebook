...
line[line.length] = Link(
  Point(linx(2.5), liny(0) - LINEBASEHEIGHT / 2),
  Point(linx(2.5), liny(0) - LINEBASEHEIGHT / 2),
)
...
}"><table border=0 cellpadding=0 cellspacing=0 height=${COMMENTEVENTHEIGHT} background="${src_commentbase_event}"><tr><td height=${COMMENTEVENTHEIGHT} valign="top" class="cmtEvnt${sizestr}" width="${
  COMMENTWIDTH - 2 * COMMENTBASESPACING - 8 * COMMENTBUTTONSIZE
}">秋生有条件参与3对3篮球赛；芽衣、美佐枝有条件参与毕业典礼（此为美佐枝参与毕业典礼的另一种途径，也是首选途径）</td></tr></table></td><td width="${COMMENTBASESPACING}"></td></tr></table></td></tr><tr><td background="${src_commentbase_base}" height="${
  COMMENTBASESPACING / 2
}"></td></tr><tr><td background="${src_commentbase_base}"><table border=0 cellpadding=0 cellspacing=0 width="${COMMENTWIDTH}"><tr><td width="${COMMENTBASESPACING}"></td><td width="${COMMENTBARWIDTH}" height="${COMMENTBARHEIGHT}" background="${src_commentbase_option_B}" valign="bottom" align="center"><div class="cmtopt${sizestr}">不代他接听`
CmtEvents = '00000010'
CmtEvntIru = '业余棒球进入必选'
