...
CmtSummery = ''
CmtSelect =
  '此处{胜平线进入}即21日，在分支{受害者遗忘的简历}选择[查清地址后送给他]；22日，在分支{课前，牡丹的处理问题}选择[把牡丹丢还给杏]或者未触发这个分支，在分支{春原求朋也帮忙装备寝室}选择[不帮忙]。没有选择相应选项或者没有触发上述第一、三个分支的情况均属于否；第一、三个分支选择正确但没有触发第二个分支的情况属于是。<br>柊胜平角色剧情攻略请参见P37。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
CmtSelect =
  '选择[紧紧抱住她]则继续渚线，否则退出渚线。风子线的攻略中，选择[就这样注视着她]，是达成TRUE ENDING的必要条件之一。'
CmtCaution = ''
CmtOption = '-就这样注视着她'
CmtEvents = '00001000'
CmtEvntIru = '风子大师达成必选'
