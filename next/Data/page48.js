...
hdft["header"]=Header("fuuko","伊吹 风子","Fuuko Ibuki","风子大师（一）","Fuuko Master~Part 1");
...
CmtEvents="";
CmtEvntIru="";
box[0][1]=Textbox_Selection_C(x(3),y(yLevel),"风子陷入幻想（一）","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"风子陷入幻想（一）",0);
...
yLevel+=2;
CmtSummery="";
CmtSelect="风子大师一共有4项常规恶作剧：[让风子用鼻子喝果汁]、[把风子带到别处去]（22日开始出现）、[找别人来装扮自己]（23日开始出现）、[偷换掉风子怀里的雕刻]（24日开始出现），一项特殊恶作剧[给风子吃早苗的面包]（29日出现）和一个隐藏恶作剧剧情。任意一个常规恶作剧完成两次后即可达到“登峰造极”（达成），恶作剧中如果再选择已经达成的项目，则会跳回重新作选择，完成的项目不会再有新的剧情。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[5][0]=Textbox_Selection_C(x(1.5),y(yLevel),"风子恶作剧（一）","2",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"风子恶作剧（一）",0);
...
yLevel+=2;
CmtSummery="";
CmtSelect="23日至26日，二级的[把风子带到别处去]剧情根据公共线路的选择有变化：若在18日的分支{有纪宁离开后}选择[睡觉]，则[把风子带到别处去]剧情发生在资料室，否则发生在校长室。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[12][0]=Textbox_Selection_C(x(0.5),y(yLevel),"风子恶作剧（二）","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"风子恶作剧（二）",0);
