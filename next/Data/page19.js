...
CmtEvents = '00010000'
CmtEvntIru =
  '如果21日在分支迟到后的午间选择赶去学生食堂而退出渚线，在此选择试试看，则渚同样可参与伪女友事件'
...
CmtSelect = ''
CmtCaution =
  '公共线路后期（宫泽有纪宁线路前期）特殊剧情。发生在23日午后，没有选择分支。内容变化与公共线路的走向和某些分支选择有关，这些相关分支的有纪宁咒语/体育仓库事件图标都高亮显示。有纪宁的咒语攻略参见P32。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[13][0] = Textbox_Option_C(
  x(2),
  y(yLevel),
  '有纪宁的咒语',
  '5',
