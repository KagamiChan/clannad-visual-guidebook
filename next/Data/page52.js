...
CmtSelect = ''
CmtCaution =
  '古河渚线路前期特殊剧情。发生在28日和30日，分成两部分，28日的内容及选择分支出现的变化与公共线路和渚线的走向和某些分支选择有关，30日的内容没有分支，剧情仍然受之前某些分支选择的影响，这些相关分支的3对3篮球赛图标都高亮显示。3对3篮球赛中的表现影响之后渚线的走向（参考古河渚线路30日注释1）以及AFTER STORY中的一些剧情，相关攻略请参见P56～P58。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
CmtSummery = ''
CmtSelect =
  '{上午，没有找到参赛伙伴}即在3对3篮球赛（一）中没有邀请到杏、椋、智代、风子、美佐枝、有纪宁中的任何一位成为参赛伙伴。3对3篮球赛相关攻略请参见P56～P58。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[4][0] = Textbox_Condition_C(
  x(2),
  y(yLevel),
  '上午，没有找到参赛伙伴',
  '2',
