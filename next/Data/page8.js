...
CmtSummery = ''
CmtSelect =
  '{15和17日，向美佐枝搭话}包括15日，在分支{宿舍走廊遇见美佐枝}选择[向她搭话]以及17日在分支{宿舍走廊遇见美佐枝}再选择[向她搭话]。两次选择都正确才满足条件。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[10][1] = Textbox_Condition_C(
  x(5),
  y(yLevel),
  '15日和17日，向美佐枝搭话',
  '8',
...
CmtSelect =
  '这是得到美佐枝“光”的关键选择分支。选则[向她搭话]继续美佐枝线，如果已经完成过美佐枝线，选择这个选项才能在进入智代角色剧情后得到美佐枝的“光”。选择[目送她离去]，退出美佐枝线。'
CmtCaution = ''
CmtOption = '-向她搭话'
CmtEvents = '01000000'
