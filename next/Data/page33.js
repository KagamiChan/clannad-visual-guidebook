...
CmtSummery = ''
CmtSelect =
  '{23日，咒语游戏中遇到渚}即在23日有纪宁的咒语中触发{咒语游戏中遇到渚}的剧情。接下来的{23日，咒语游戏中遇到……}同样是这个意思。<br>此处，如果在16日的分支{古河重新创立话剧社}中选择[帮助]（即之后朋也认识了古河的家人），那么即使在23日咒语游戏中没有触发遇到渚的剧情，同样符合是的条件。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[6][0] = Textbox_Condition_C(
  x(1.5),
  y(yLevel),
  '23日，咒语游戏中遇到渚',
  '1',
