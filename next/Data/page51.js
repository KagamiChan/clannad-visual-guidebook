...
}">芳野参与3对3篮球赛</td></tr></table></td><td width="${COMMENTBASESPACING}"></td></tr></table></td></tr><tr><td background="${src_commentbase_base}" height="${
  COMMENTBASESPACING / 2
}"></td></tr><tr><td background="${src_commentbase_base}"><table border=0 cellpadding=0 cellspacing=0 width="${COMMENTWIDTH}"><tr><td width="${COMMENTBASESPACING}"></td><td width="${COMMENTBARWIDTH}" height="${COMMENTBARHEIGHT}" background="${src_commentbase_option_B}" valign="bottom" align="center"><div class="cmtopt${sizestr}">不要让他加入`
CmtEvents = '00100000'
...
CmtEvents = '00100001'
CmtEvntIru =
  '秋生有条件参与3对3篮球赛；芽衣、美佐枝参与毕业典礼（此为美佐枝参与毕业典礼的另一种途径，也是首选途径）'
