...
CmtEvents = '00100000'
CmtEvntIru =
  '如果21日前未退出渚线也未能使渚参与伪女友事件，此处选择赶去学生食堂，渚仍然有条件参与伪女友事件'
...
CmtSelect = ''
CmtCaution =
  '公共线路前期至伊吹风子线路前期特殊剧情。发生在21日至30日的十天内，共9部分。选择分支的变化与仅与事件内部的分支选择有关，但9部分内容是否都能触发以及剧情变化仍受公共线路中的走向以及某些分支选择的影响，这些相关分支的风子大师图标都高亮显示。风子大师相关攻略请参见P48～P50。'
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
...
line[line.length] = Link(
  Point(linx(2), liny(-1)),
  Point(linx(2), liny(-13)),
  Point(linx(1), liny(-14)),
  box[13][0],
)
line[line.length] = Link(
  Point(linx(2), liny(-1)),
