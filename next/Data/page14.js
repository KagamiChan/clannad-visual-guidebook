...
CmtSummery = ''
CmtSelect =
  '此处{智代线进入}即下午，在分支{有智代的陪同}选择[的确不错]。没有选择相应选项或者没有触发分支的情况均属于否。<br>{有纪宁线进入}即18日，在分支{逃课选择睡觉的地方}选择[到那里去睡]，在接下来的分支{下课后，走进资料室的女孩}选择[再说几句话]；或者18日在分支{逃课选择睡觉的地方}选择[还是回教室吧]或者未触发这个分支，并且19日在分支{下课后，走进资料室的女孩}选择[再说几句话]。其他情况都属于没有进入有纪宁线。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
box[12][0] = Textbox_Condition_C(
  x(3),
  y(yLevel),
  '智代线或者有纪宁线进入',
  '4',
...
CmtSelect =
  '选择[还是去美佐枝的房间]，则完全进入美佐枝线，并同时退出智代线、有纪宁线以及藤林姐妹线（若已进入）。相乐美佐枝角色剧情攻略请参见P26。'
CmtCaution = ''
CmtOption = ''
CmtEvents = ''
CmtEvntIru = ''
