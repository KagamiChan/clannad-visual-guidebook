...
function moveMeBy(name, x, y) {
  ...
  const obj = getObjectRef(name)
  if (obj) {
    obj.style.top = parseInt(obj.style.top) + parseInt(y)
    obj.style.left = parseInt(obj.style.left) + parseInt(x)
  }
}
function addMouseClick(name, func) {
  //给对象增加onclick事件
  const obj = getObjectRef(name)
  const ret = obj.onclick
  if (obj) {
    obj.onclick = func
...
const lineRecord = new Array()
const rqst = GetRequest()

const box = new Array()
const line = new Array()
const comment = new Array()
let commentShown = true
const board = new Array()
var blockshow = false
const hdft = new Array()

const COMMENTBGZINDEX = 5
const BOARDZINDEX = 5
const LINEZINDEX = 6
const COMMENTZINDEX = 7
const BUTTONZINDEX = 8
const CHECKZINDEX = 9
...
const src_background = `${sizestr}/${folder[0]}Background_Pattern${appendix}`

const src_Textbox_Block = `${sizestr}/${folder[5]}Textbox_Block${appendix}`
const src_Textbox_Condition = `${sizestr}/${folder[5]}Textbox_Condition${appendix}`
const src_Textbox_Selection = `${sizestr}/${folder[5]}Textbox_Selection${appendix}`
//var src_Textbox_Jump=		sizestr+"/"+folder[5]+"Textbox_Jump"			+appendix;
const src_Textbox_Option = `${sizestr}/${folder[5]}Textbox_Option${appendix}`
const src_Textbox_Date = `${sizestr}/${folder[5]}Textbox_Date${appendix}`
const src_bubble_enter = `${sizestr}/${folder[1]}Bubble_Enter${appendix}`
const src_bubble_exit = `${sizestr}/${folder[1]}Bubble_Exit${appendix}`
const src_bubble_untrigger = `${sizestr}/${folder[1]}Bubble_Untrigger${appendix}`

const src_route_public = `${sizestr}/${folder[3]}Title_Mark_Public${appendix}`
const src_route_misae = `${sizestr}/${folder[3]}Title_Mark_Misae${appendix}`
const src_route_tomoyo = `${sizestr}/${folder[3]}Title_Mark_Tomoyo${appendix}`
const src_route_yukine = `${sizestr}/${folder[3]}Title_Mark_Yukine${appendix}`
const src_route_fujibayashi = `${sizestr}/${folder[3]}Title_Mark_Fujibayashi${appendix}`
const src_route_kappei = `${sizestr}/${folder[3]}Title_Mark_Kappei${appendix}`
const src_route_sunohara = `${sizestr}/${folder[3]}Title_Mark_Sunohara${appendix}`
const src_route_kotomi = `${sizestr}/${folder[3]}Title_Mark_Kotomi${appendix}`
const src_route_fuuko = `${sizestr}/${folder[3]}Title_Mark_Fuuko${appendix}`
const src_route_nagisa = `${sizestr}/${folder[3]}Title_Mark_Nagisa${appendix}`
const src_route_gunfight = `${sizestr}/${folder[3]}Title_Mark_Gunfight${appendix}`
const src_header_bg = `${sizestr}/${folder[3]}Title_Frame${appendix}`

const src_footer_top = `${sizestr}/${folder[0]}Background_Frame[A]${appendix}`
const src_footer_mid = `${sizestr}/${folder[0]}Background_Frame[B]${appendix}`
const src_footer_bottom = `${sizestr}/${folder[0]}Background_Frame[C]${appendix}`
const num0 = `${sizestr}/${folder[7]}Number_0${appendix}`
const num1 = `${sizestr}/${folder[7]}Number_1${appendix}`
const num2 = `${sizestr}/${folder[7]}Number_2${appendix}`
const num3 = `${sizestr}/${folder[7]}Number_3${appendix}`
const num4 = `${sizestr}/${folder[7]}Number_4${appendix}`
const num5 = `${sizestr}/${folder[7]}Number_5${appendix}`
const num6 = `${sizestr}/${folder[7]}Number_6${appendix}`
const num7 = `${sizestr}/${folder[7]}Number_7${appendix}`
const num8 = `${sizestr}/${folder[7]}Number_8${appendix}`
const num9 = `${sizestr}/${folder[7]}Number_9${appendix}`
const num0_s = `${sizestr}/${folder[7]}Number_0${appendix}`
const num1_s = `${sizestr}/${folder[7]}Number_1${appendix}`
const num2_s = `${sizestr}/${folder[7]}Number_2${appendix}`
const num3_s = `${sizestr}/${folder[7]}Number_3${appendix}`
const num4_s = `${sizestr}/${folder[7]}Number_4${appendix}`
const num5_s = `${sizestr}/${folder[7]}Number_5${appendix}`
const num6_s = `${sizestr}/${folder[7]}Number_6${appendix}`
const num7_s = `${sizestr}/${folder[7]}Number_7${appendix}`
const num8_s = `${sizestr}/${folder[7]}Number_8${appendix}`
const num9_s = `${sizestr}/${folder[7]}Number_9${appendix}`
const src_footer_page = new Array(num0, num1, num2, num3, num4, num5, num6, num7, num8, num9)
src_footer_page['FIN'] = `${sizestr}/${folder[7]}Number_Fin${appendix}`
const src_footer_page_select = new Array(
  num0_s,
  num1_s,
  num2_s,
  num3_s,
...
const src_commentbase_check = `${sizestr}/${folder[2]}Comment_Check${appendix}`
const src_commentbase_title = `${sizestr}/${folder[2]}Comment_Frame_Title${appendix}`
const src_commentbase_base = `${sizestr}/${folder[2]}Comment_Frame_Description${appendix}`
const src_commentbase_comment = `${sizestr}/${folder[2]}Comment_Frame_Comment${appendix}`
const src_commentbase_hint = `${sizestr}/${folder[2]}Comment_Mark_Hint${appendix}`
const src_commentbase_option_A = `${sizestr}/${folder[2]}Comment_Option_A${appendix}`
const src_commentbase_option_B = `${sizestr}/${folder[2]}Comment_Option_B${appendix}`
const src_commentbase_event = `${sizestr}/${folder[2]}Comment_Tips${appendix}`

const jien1 = `${sizestr}/${folder[2]}Comment_Mark_64HIT[A]${appendix}`
const jien2 = `${sizestr}/${folder[2]}Comment_Mark_Spell[A]${appendix}`
const jien3 = `${sizestr}/${folder[2]}Comment_Mark_Basketball[A]${appendix}`
const jien4 = `${sizestr}/${folder[2]}Comment_Mark_FakeGF[A]${appendix}`
const jien5 = `${sizestr}/${folder[2]}Comment_Mark_Master[A]${appendix}`
const jien6 = `${sizestr}/${folder[2]}Comment_Mark_Impression[A]${appendix}`
const jien7 = `${sizestr}/${folder[2]}Comment_Mark_Baseball[A]${appendix}`
const jien8 = `${sizestr}/${folder[2]}Comment_Mark_Graduation[A]${appendix}`
const src_comment_mark_en = new Array(jien1, jien2, jien3, jien4, jien5, jien6, jien7, jien8)

const jiun1 = `${sizestr}/${folder[2]}Comment_Mark_64HIT[B]${appendix}`
const jiun2 = `${sizestr}/${folder[2]}Comment_Mark_Spell[B]${appendix}`
const jiun3 = `${sizestr}/${folder[2]}Comment_Mark_Basketball[B]${appendix}`
const jiun4 = `${sizestr}/${folder[2]}Comment_Mark_FakeGF[B]${appendix}`
const jiun5 = `${sizestr}/${folder[2]}Comment_Mark_Master[B]${appendix}`
const jiun6 = `${sizestr}/${folder[2]}Comment_Mark_Impression[B]${appendix}`
const jiun7 = `${sizestr}/${folder[2]}Comment_Mark_Baseball[B]${appendix}`
const jiun8 = `${sizestr}/${folder[2]}Comment_Mark_Graduation[B]${appendix}`
const src_comment_mark_un = new Array(jiun1, jiun2, jiun3, jiun4, jiun5, jiun6, jiun7, jiun8)

const src_dot_v = `${sizestr}/${folder[4]}Line_1${appendix}`
const src_dot_hv = `${sizestr}/${folder[4]}Line_2${appendix}`
const src_dot_h = `${sizestr}/${folder[4]}Line_3${appendix}`

const src_board_top = `${sizestr}/${folder[6]}Board_Frame_Top${appendix}`
const src_board_mid = `${sizestr}/${folder[6]}Board_Frame_Body${appendix}`
const src_board_bottom = `${sizestr}/${folder[6]}Board_Frame_Bottom${appendix}`
...
function FooterBase(x, y, height, page) {
  ...
  this.HTML += `<tr><td height="${COMMENTBGBOTTOMHEIGHT}" style="${getBgStr(
    src_footer_bottom,
  )}"></td></tr>`
  this.HTML += '</table>'
  this.HTML += '</div>'
...
function ButtonBase(x, y, type, text, css, adjustw) {
  ...
  switch (this.type) {
    case 'enter': {
      this.bgsrc = src_bubble_enter
      this.width = BUBBLEWIDTH
      this.height = BUBBLEHEIGHT
      this.zindex = BUTTONZINDEX
      break
    }
    case 'exit': {
      this.bgsrc = src_bubble_exit
      this.width = BUBBLEWIDTH
      this.height = BUBBLEHEIGHT
      this.zindex = BUTTONZINDEX
      break
    ...
    case 'untrigger': {
      this.bgsrc = src_bubble_untrigger
      this.width = BUBBLEWIDTH
      this.height = BUBBLEHEIGHT
      this.zindex = BUTTONZINDEX
      break
    ...
    case 'condition': {
      this.bgsrc = src_Textbox_Condition
      this.width = BUTTONWIDTH
      this.height = BUTTONHEIGHT
      this.zindex = BUTTONZINDEX
      break
    ...
    case 'selection': {
      this.bgsrc = src_Textbox_Selection
      this.width = BUTTONWIDTH
      this.height = BUTTONHEIGHT
      this.zindex = BUTTONZINDEX
      break
    ...
    case 'date': {
      this.bgsrc = src_Textbox_Date
      this.width = DATEWIDTH
      this.height = DATEHEIGHT
      this.zindex = BUTTONZINDEX
      break
    }
    case 'ccheck': {
      this.bgsrc = src_commentbase_check
      this.width = CHECKSIZE
      this.height = CHECKSIZE
      this.zindex = CHECKZINDEX
      break
    }
    case 'gcheck': {
      this.bgsrc = src_graphbase_check
      this.width = CHECKSIZE
      this.height = CHECKSIZE
      this.zindex = CHECKZINDEX
      break
  ...
  this.HTML += `<table id="${this.ref}Table" height=${this.height} width=${
    this.width
  } border=0 cellpadding=0 cellspacing=0 style="${getBgStr(this.bgsrc)}" ref="${
    this.ref
  }"><tr><td width=${this.width} align="center" valign="middle"><div id="${
    this.ref
  }Content" class="${this.css}${sizestr}">${this.title}</div></td></tr></table>`
  this.HTML += '</div>'
  documentWrite(this.HTML)
  ...
  this.addClick = function (func, move) {
    if (move) {
      this.addOver(function () {
        objArr[this.ref].moveBy(-1, -1)
      })
  ...
  if (this.route) {
    if (this.route[0] == 'l') {
      ...
      for (i = 1; i < this.route.length; i++) {
        ...
        this.route[i] = new ButtonBase(
          this.leftx + currentOffWidth,
          currentTop,
          tempType,
          this.route[i],
          'routebtn',
        ...
        if (i == 3) {
          currentOffWidth = 0
          currentTop = this.topy + this.height - BUBBLEOFFSETHEIGHT2
        }
      }
    } else {
...
function CommentBase(
  ...
  this.HTML += `<tr><td background="${
    this.titlebgsrc
  }"><table border=0 cellpadding=0 cellspacing=0 height="${COMMENTTITLEHEIGHT}" width="${
    this.width
  }"><tr><td width="${COMMENTBASESPACING}"></td><td width="${
    CHECKSIZE - 2 * outersize
  }" align="center" class="${titlecss}${sizestr}">${
    this.num
  }</td><td width="${COMMENTBASESPACING}"></td><td width="${
    this.width - (CHECKSIZE - 2 * outersize) - 4 * COMMENTBASESPACING
  }" align="left" class="${titlecss}${sizestr}">${this.title}</td><td width="${
    2 * COMMENTBASESPACING
  }"></td></tr></table></td></tr>`
  if (this.summary != '')
    this.HTML += `<tr><td  background="${
      this.basebgsrc
    }"><table border=0 cellpadding=0 cellspacing=0 width="${this.width}"><tr><td width="${
      2 * COMMENTBASESPACING
    }"></td><td width="${
      this.width - 4 * COMMENTBASESPACING
    }" align="left" class="${contentcss}${sizestr}" colspan=2>${this.summary}</td><td width="${
      2 * COMMENTBASESPACING
    }"></td></tr></table></td></tr>`
  if (this.hint != '')
    this.HTML += `<tr><td background="${
      ...
      this.width - 4 * COMMENTBASESPACING
    }" align="left" class="${contentcss}${sizestr}" colspan=2>${this.hint}</td><td width="${
      2 * COMMENTBASESPACING
    }"></td></tr></table></td></tr>`
  if (this.setsumei != '')
    this.HTML += `<tr><td background="${
      ...
      COMMENTBUTTONSIZE + COMMENTBASESPACING / 2
    }" align="left" valign="top">${getImgStr(
      src_commentbase_hint,
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )}</td><td width="${
      this.width - 4 * COMMENTBASESPACING - COMMENTBASESPACING / 2
    }" align="left" valign="top" class="${contentcss}${sizestr}">${this.setsumei}</td><td width="${
      2 * COMMENTBASESPACING
    }"></td></tr></table></td></tr>`
  this.HTML += `<tr><td background="${this.basebgsrc}" height="${
  ...
  if (this.option != '') {
    ...
    for (i = 0; i < tempString.length && i < 3; i++) {
      if (tempString[i].charAt(0) == '-')
        this.HTML += `<td width="${COMMENTBARWIDTH}" height="${COMMENTBARHEIGHT}" style="${getBgStr(
          src_commentbase_option_B,
        )}" valign="bottom" align="center"><div class="${optioncss}${sizestr}">${tempString[
          i
        ].substring(1)}</div></td>`
      else
        this.HTML += `<td width="${COMMENTBARWIDTH}" height="${COMMENTBARHEIGHT}" style="${getBgStr(
          src_commentbase_option_A,
        )}" valign="bottom" align="center"><div class="${optioncss}${sizestr}">${tempString[
          i
        ].substring(1)}</div></td>`
    }
  ...
  if (this.icon != '') {
    ...
    }" height="${COMMENTBUTTONSIZE}" valign="bottom" align="left" class="${contentcss}${sizestr}">`
    this.HTML += getImgStr(
      this.icon.charAt(0) == '1' ? src_comment_mark_en[0] : src_comment_mark_un[0],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(1) == '1' ? src_comment_mark_en[1] : src_comment_mark_un[1],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(2) == '1' ? src_comment_mark_en[2] : src_comment_mark_un[2],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(3) == '1' ? src_comment_mark_en[3] : src_comment_mark_un[3],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(4) == '1' ? src_comment_mark_en[4] : src_comment_mark_un[4],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(5) == '1' ? src_comment_mark_en[5] : src_comment_mark_un[5],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(6) == '1' ? src_comment_mark_en[6] : src_comment_mark_un[6],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += getImgStr(
      this.icon.charAt(7) == '1' ? src_comment_mark_en[7] : src_comment_mark_un[7],
      COMMENTMARKSIZE,
      COMMENTMARKSIZE,
    )
    this.HTML += `</td><td width="${
      this.width - COMMENTBASESPACING - 8 * COMMENTBUTTONSIZE
    }"><table border=0 cellpadding=0 cellspacing=0 height=${COMMENTEVENTHEIGHT} width=${COMMENTEVENTWIDTH} style="${getBgStr(
      this.eventsrc,
    )}"><tr><td height=${COMMENTEVENTHEIGHT} valign="middle" class="${eventcss}${sizestr}" width="${
      this.width - 2 * COMMENTBASESPACING - 8 * COMMENTBUTTONSIZE
    }">${
      this.iconillu
    }</td></tr></table></td><td width="${COMMENTBASESPACING}"></td></tr></table></td></tr>`
  }
  this.HTML += `<tr><td background="${this.basebgsrc}" height="${
    COMMENTBASESPACING / 2
  }"></td></tr>`
  ...
  this.addOver = function (func) {
    return addMouseOver(`${this.ref}Face`, func)
  }
  this.remOver = function () {
    remMouseOver(`${this.ref}Face`)
  }
  this.addOut = function (func) {
    return addMouseOut(`${this.ref}Face`, func)
  }
  this.remOut = function () {
    remMouseOut(`${this.ref}Face`)
  }
  this.addClick = function (func, move) {
    if (move) {
      this.addOver(function () {
    ...
    return addMouseClick(`${this.ref}Face`, func)
  }
  this.remClick = function () {
    remMouseClick(`${this.ref}Face`)
    this.remOver()
    this.remOut()
  }
  this.addTitle = function (title) {
...
function vmlline(x, y, l, h) {
  ...
  this.HTML += `<div id="${this.ref}Wrap" style="position:absolute; width:0px; left:${
    this.leftx
  }px; top:${this.topy}px; height:0px; z-index:${
    this.zindex
  }; overflow:visible; visibility:hidden; padding-top:${
    2 * outersize
  }px; margin-left:${LINEADJUSTX}px;"><div id="${this.ref}Link"></div>`
  for (i = 0; i < this.times; i++) {
    if (this.type == 'v') {
      if (lineRecord[`${this.leftx}|${this.topy + i * LINEBASEHEIGHT}|${this.type}`] != true) {
        ...
        this.HTML += `<div style=" width:${LINESIZE}px; height:${
          LINEBASEHEIGHT + 2 * outersize
        }px; margin-top:-${2 * outersize}px;"><table border=0 cellpadding=0 cellspacing=0 height="${
          LINEBASEHEIGHT + 2 * outersize
        }" width="${LINESIZE}" style="${getBgStr(this.bgsrc)}"><tr><td></td></tr></table></div>`
      } else {
        this.HTML += `<div style=" width:${LINESIZE}px; height:${
          LINEBASEHEIGHT + 2 * outersize
        }px; margin-top:-${2 * outersize}px;"><table border=0 cellpadding=0 cellspacing=0 height="${
          LINEBASEHEIGHT + 2 * outersize
        }" width="${LINESIZE}"><tr><td></td></tr></table></div>`
      }
    } else if (this.type == 'h') {
      if (lineRecord[`${this.leftx + i * LINEBASELENGTH}|${this.topy}|${this.type}`] != true) {
        ...
        this.HTML += `<div style=" width:${
          LINEBASELENGTH + 2 * outersize
        }px; height:${LINESIZE}px; margin-top:-${
          2 * outersize + LINEOUTERSIZEADJUST
        }px; margin-left:${
          i * LINEBASELENGTH
        }px;"><table border=0 cellpadding=0 cellspacing=0 height="${LINESIZE}" width="${
          LINEBASELENGTH + 2 * outersize
        }" style="${getBgStr(this.bgsrc)}"><tr><td></td></tr></table></div>`
      } else {
        this.HTML += `<div style=" width:${
          LINEBASELENGTH + 2 * outersize
        }px; height:${LINESIZE}px; margin-top:-${
      ...
      this.HTML += `<div id="${this.ref}Face" style=" width:${LINESIZE}px; height:${
        LINEBASEHEIGHT / 2 + 2 * outersize
      }px;${getBgStr(this.bgsrc)} margin-top:-${2 * outersize}px;"></div>`
  }
  this.HTML += '</div>'
  ...
  this.addClick = function (func) {
    if (this.type == 'hv') return addMouseClick(`${this.ref}Face`, func)
  }
  this.remClick = function () {
    if (this.type == 'hv') remMouseClick(`${this.ref}Face`)
  }
  this.addTitle = function (title) {
    if (this.type == 'hv') addTitle(`${this.ref}Wrap`, title)
  }
  this.remTitle = function () {
    if (this.type == 'hv') remTitle(`${this.ref}Wrap`)
  }
...
function Linkline() {
  ...
  if (args[args.length - 1].lowercenter != null)
    this.Points[this.Points.length] = args[args.length - 1].lowercenter
  else this.Points[this.Points.length] = args[args.length - 1]
  this.Lines = new Array()

  for (j = 0; j < this.Points.length - 1; j++) {
    if (
      this.Points[j].leftx != this.Points[j + 1].leftx &&
      this.Points[j].topy != this.Points[j + 1].topy
    ) {
      this.Lines[this.Lines.length] = new vmlline(
        this.Points[j].leftx,
        this.Points[j].topy - LINEBASEHEIGHT - outersize + HALFDOTSIZE,
        0,
        LINEBASEHEIGHT,
      )
      this.Lines[this.Lines.length] = new vmlline(
        Math.min(this.Points[j].leftx, this.Points[j + 1].leftx),
        this.Points[j].topy - LINEBASEHEIGHT - outersize + HALFDOTSIZE + LINEOUTERSIZEADJUST,
        Math.abs(this.Points[j].leftx - this.Points[j + 1].leftx),
        0,
      )
      if (this.Points[j].topy - this.Points[j + 1].topy > LINEBASEHEIGHT)
        this.Lines[this.Lines.length] = new vmlline(
          this.Points[j + 1].leftx,
          this.Points[j + 1].topy - HALFDOTSIZE,
          0,
          this.Points[j].topy - this.Points[j + 1].topy - LINEBASEHEIGHT,
        )
    } else if (this.Points[j].leftx == this.Points[j + 1].leftx) {
      this.Lines[this.Lines.length] = new vmlline(
        this.Points[j].leftx,
        this.Points[j + 1].topy - LINEVERTICALADJUST,
        0,
        this.Points[j].topy - this.Points[j + 1].topy,
      )
      ...
      this.Lines[this.Lines.length] = new vmlline(
        Math.min(this.Points[j].leftx, this.Points[j + 1].leftx),
        this.Points[j].topy - LINEHORIZONALADJUST,
        Math.abs(this.Points[j].leftx - this.Points[j + 1].leftx),
        0,
      )
    }
  ...
  this.addClick = function (func, move) {
    this.Lines[0].addClick(func, move)
  }
  this.remClick = function () {
    this.Lines[0].remClick()
  }
  this.addTitle = function (title) {
    this.Lines[0].addTitle(title)
  }
  this.remTitle = function () {
    this.Lines[0].remTitle()
  }
}
...
function BoardBase(x, y, height) {
  ...
  this.HTML += `<div id="${this.ref}Wrap" style="position:absolute; width:0px; left:${this.leftx}px; top:${this.topy}px; height:0px; z-index:${this.zindex}; overflow:visible; visibility:hidden;">`
  this.HTML += `<table id="${this.ref}Table" width=${this.width} border=0 cellpadding=0 cellspacing=0 ref="${this.ref}">`
  this.HTML += `<tr><td height=${BORADFOOTERHEIGHT} align="center" style="${getBgStr(
    src_board_top,
  )}" valign="middle"></td></tr>`
  for (i = 0; i < this.times; i++) {
    this.HTML += `<tr><td height=${BOARDREAPETHEIGHT} align="center" style="${getBgStr(
      src_board_mid,
    )}" valign="middle"></td></tr>`
  }
  this.HTML += `<tr><td height=${BORADFOOTERHEIGHT} align="center" style="${getBgStr(
...
function Textbox_Date(x, y, text, type) {
  if (type == 'top')
    tempObj = new ButtonBase(
      x + (BUTTONWIDTH - DATEWIDTH) / 2,
      y - (DATEHEIGHT - BUTTONHEIGHT),
      'date',
      text,
      'date',
    )
...
function Textbox_Condition_C(
  ...
  if (
    ...
    tempObj.init(
      new ButtonBase(x - (CHECKSIZE - 2 * outersize) / 2, y, 'ccheck', number, 'check'),
      null,
    )
  else
    tempObj.init(
      ...
      new CommentBase(
        COMMENTLEFT,
        parseInt(y) - COMMENTBASESPACING + yAdjust,
        Title,
        number,
        Summery,
        Select,
...
function Board(y, y2) {
  tempObj = new BoardBase(
    0,
    y - BOARDREAPETHEIGHT * 2.5 - YSCALE / 2,
    y2 - y + BOARDREAPETHEIGHT * 6,
  )
  return tempObj
}
...
//Position Manage
function x(x) {
  return BasicX + XSCALE * x
}
function xx(xx) {
  return BasicX + XSCALE * x + XSCALE / 2
}
function y(y) {
  return BasicY + YSCALE * y
}
function liny(yy) {
  return y(yLevel) + YSCALE * yy
}
function linx(xx) {
  return x(xx + 1) - (XSCALE * 2 - BUTTONWIDTH) / 2 - outersize
}
function getYlevel(y) {
  return Math.floor((y - BasicY) / YSCALE)
}
...
const pic_src = new Array(
  ...
  num9,
  src_Textbox_Block,
  src_Textbox_Condition,
  src_Textbox_Selection,
  /*src_Textbox_Jump,*/ src_Textbox_Option,
  src_Textbox_Date,
  src_bubble_enter,
  src_bubble_exit,
  src_bubble_untrigger,
  src_route_public,
  src_route_misae,
  src_route_tomoyo,
  src_route_yukine,
  src_route_fujibayashi,
  src_route_kappei,
  src_route_sunohara,
  src_route_kotomi,
  src_route_fuuko,
  ...
  src_footer_mid,
  src_footer_bottom,
  src_commentbase_check,
  src_commentbase_title,
  src_commentbase_base,
  src_commentbase_comment,
  src_commentbase_hint,
  src_commentbase_option_A,
  src_commentbase_option_B,
  src_commentbase_event,
  jien1,
  jien2,
  jien3,
  jien4,
...
function checkPic(i) {
  ...
  if (i == 0) {
    updateLoadingProcess(0, pic_src.length)
  }
  if (!picInited) {
  ...
  if (!checkPicObj[i].complete)
    checkTimeout = window.setTimeout(`checkPic(${i},${pic_src.length})`, 10)
  else {
    picInited = false
    updateLoadingProcess(i + 1, pic_src.length)
    checkTimeout = window.setTimeout(`checkPic(${i + 1},${pic_src.length})`, 10)
  }
}
function updateLoadingProcess(i, n) {
  ...
  if (i == 0) {
    ...
    getObjectRef('loadingStatus').style.display = 'block'
    return
  }
}
...
function cancelWheel(type) {
  if (type) document.onmousewheel = () => false
...
function blinkStart(obj) {
  ...
  if (!blinkOriFunc) blinkOriFunc = () => false
  blink(blinkObj, false)
}
function blink(obj, toShow) {
  if (BlinkStop) {
    obj.show()
    if (obj.type == 'ccheck') obj.moveTo(obj.leftx - 1, obj.topy - 1)
    obj.addOver(blinkOriFunc)
    return
  }
  if (toShow) obj.show()
  else obj.hide()
...
function checkBlink() {
  ...
  if (isNaN(hkuc1) || hkuc1 > box.length) return
  if (isNaN(hkuc2) || hkuc2 > box[hkuc1].length) return
