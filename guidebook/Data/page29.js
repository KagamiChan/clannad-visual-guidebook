...
hdft["header"]=Header("tomoyo","坂上 智代","Tomoyo Sakagami","5月6日～5月11日","May 6th~May 11th");
...
CmtEvents="10000000";
CmtEvntIru="杏参与64HIT";
box[1][0]=Textbox_Selection_C(x(3.5),y(yLevel),"纷争之间的处理","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"纷争之间的处理",0);
...
box[10][0]=Textbox_Selection_C(x(4),y(yLevel),"被踢飞过来的春原","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"被踢飞过来的春原",0);
...
CmtSummery="";
CmtSelect="";
CmtCaution="坂上智代线路后期特殊剧情。发生在11日午前，没有选择分支。内容变化与公共线路和智代线众多分支的选择有关，这些相关分支的智代64HIT图标都高亮显示。智代64HIT相关攻略请参见P30。";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[12][0]=Textbox_Option_C(x(3),y(yLevel),"智代64HIT","2",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"智代64HIT",0);
...
CmtSelect="如果之前完成过美佐枝线（达成GOOD ENDING），并在18日的分支{宿舍走廊遇见美佐枝}中选择[向她搭话]，该选择分支就会出现。选则[帮忙]，可以得到美佐枝的“光”。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[15][0]=Textbox_Selection_C(x(3),y(yLevel),"帮美佐枝找她的猫","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"帮美佐枝找她的猫",0);
