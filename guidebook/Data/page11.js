...
CmtSelect="18日遇见有纪宁后马上就离开了资料室，退出有纪宁线，出现的三个选择项为[去社团活动室]、[去图书室]、[回家]，否则[回家]选项将被替换成[去资料室]。若18日未进入有纪宁线，选择[去资料室]如果您要进入有纪宁线，这是最后的机会。";
CmtCaution="";
CmtOption="-去资料室";
CmtEvents="10000000";
CmtEvntIru="有纪宁参与64HIT。如果18日在分支逃课选择睡觉的地方选择到那里去睡，则此处的选择没有影响";
box[4][0]=Textbox_Selection_C(x(2),y(yLevel),"来到旧校舍后的去向（一）","6",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"来到旧校舍后的去向",0);
