...
CmtSummery="";
CmtSelect="";
CmtCaution="伊吹风子线路中期特殊剧情。发生于3日上午，触发条件与2日风子线分支的选择有关。所有选项均不影响剧情发展。特别授课教师推选相关攻略请参见P47。";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[7][0]=Textbox_Option_C(x(2),y(yLevel),"特别授课教师推选","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"特别授课教师推选",0);
