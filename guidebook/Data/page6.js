...
box[4][1]=Textbox_Selection_C(x(5),y(yLevel),"宿舍走廊遇见美佐枝","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"宿舍走廊遇见美佐枝",0);
...
CmtSummery="等候做值日生的古河许久，朋也决定出去找她。走过隔壁教室，朋也推开门，发现窗边独自坐着一个陌生的女生，正在认真地用手中的木片雕刻着什么。";
CmtSelect="若在16日的分支{古河重新创立话剧社}中选择[帮助]，就会以这样的剧情安排与风子相遇。在以下连续的三个分支中，选择出去[找找她]、[去隔壁的教室看一下]、[向她搭话]（即不跳出风子线），则18日您才可能认识风子（同样，即使进入风子线，朋也仍不知道风子的姓名）。";
CmtCaution="";
CmtOption="+出去找找她|+去隔壁的教室看一下|-向她搭话";
CmtEvents="11111010";
CmtEvntIru="风子有条件参与64HIT、有纪宁的咒语、体育仓库事件、3对3篮球赛、伪女友事件和业余棒球；风子大师进入必选";
box[8][1]=Textbox_Selection_C(x(4),y(yLevel),"等候做值日生的古河","4",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"与风子相遇（风子线已进入版）",0);
...
CmtSummery="春原仍然没有从打击中恢复，朋也决定独自打发放学后的时光。来到旧校舍，走进本以为没人的空教室，朋也发现原来窗边独自坐着一个女生，正在认真地用手中的木片雕刻着什么。";
CmtSelect="16日无论是否帮助了渚重建话剧社，您都可能在17日遇到风子。<br>如果在16日分支{古河重新创立话剧社}中选择让她一个人做或者未触发这个选项（即没有进入进入风子线和渚线），则17日午后，在以下连续的三个分支中，选择[在校内闲逛]、[睡一觉]、[向她搭话]，则18日您仍有机会认识风子。和风子线进入版不同的是，这之后即使认识了风子也不能进入风子角色剧情。";
CmtCaution="风子是CLANNAD中最为活跃的角色。除琴美好感度以外，所有的特殊事件都有风子参与，而18日认识风子是风子参与这些事件的关键节点，因此“认识风子”很重要。";
CmtOption="+在校内闲逛|+向她搭话|-睡一觉";
CmtEvents="11111010";
CmtEvntIru="风子有条件参与64HIT、有纪宁的咒语、体育仓库事件、3对3篮球赛、伪女友事件和业余棒球；风子大师进入必选";
box[14][1]=Textbox_Selection_C(x(4),y(yLevel),"放学后，一个人的朋也","5",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"与风子相遇（风子线未进入版）",0);
line[line.length]=Link(Point(linx(4),liny(0)-LINEBASEHEIGHT/2),Point(linx(4),liny(0)-LINEBASEHEIGHT/2));
board[board.length]=Board(liny(0),liny(18));
//----------
box[15]=new Array();
