...
hdft["header"]=Header("sunohara","春原  阳平/春原 芽衣","Youhei Sunohara / Mei Sunohara","4月24日～芽衣","April 24th~Mei");
...
CmtSummery="";
CmtSelect="";
CmtCaution="春原兄妹路线前期特殊剧情。发生在24日一天之内，内容及选择分支出现的变化与公共路线的走向和某些分支选择有关，同时也和有纪宁的骤雨中部分剧情内容有关，这些相关分支的伪女友事件图标都高亮显示。伪女友事件相关攻略请参见P39";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[1][0]=Textbox_Option_C(x(3),y(yLevel),"伪女友事件","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"伪女友事件",0);
