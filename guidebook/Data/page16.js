...
box[2][0]=Textbox_Selection_C(x(2),y(yLevel),"坂道上遇到智代","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"坂道上遇到智代",0);
...
box[10][0]=Textbox_Selection_C(x(3),y(yLevel),"咨询指导老师的问题","4",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"咨询指导老师的问题",0);
