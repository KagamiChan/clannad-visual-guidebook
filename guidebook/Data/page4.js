...
CmtSelect="这是学院篇前期重要节点。选择[帮忙]则继续进行渚线和风子线；选择[让她一个人做]则有可能进入美佐枝线、胜平线和智代线的角色剧情，分支对此三条路线的影响要等到学院篇后期才会显现出来。";
CmtCaution="";
CmtOption="-帮忙";
CmtEvents="01000000";
CmtEvntIru="渚参与体育仓库事件";
box[6][0]=Textbox_Selection_C(x(1.5),y(yLevel),"古河重新创立话剧社","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"古河重新创立话剧社",0);
