...
box[7]=new Array();
yLevel+=3;
CmtSummery="遭受到沉重打击春原仍然坚信：智代之所以强大是因为她是个男的。为了验证自己想法，下课后，他第三次叫上朋也，向智代发起挑战……";
CmtSelect="17日上午春原三次挑战智代只有第三次的选择是关键。若选择[不去管他]，则跳出智代线。";
CmtCaution="";
CmtOption="-跟着他去";
CmtEvents="01110011";
CmtEvntIru="智代成为3对3篮球赛成员候选，参与伪女友事件，有条件参与有纪宁的咒语、体育仓库事件和毕业典礼；业余棒球进入必选";
box[7][0]=Textbox_Selection_C(x(2.5),y(yLevel),"春园挑战智代（四回目）","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"春园挑战智代",0);
...
yLevel+=4;
CmtSummery="";
CmtSelect="{15或16日，逃课遇见琴美}包括15日在分支{上午、英语语法课}选择[逃课]以及在16日的分支{上午、课上}选择[逃课]，触发其一（只可能触发其一）就满足逃课遇见琴美的条件。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[9][0]=Textbox_Condition_C(x(3.5),y(yLevel),"15日或16日，逃课遇见琴美","2",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"15日或16日，逃课遇见琴美",0);
