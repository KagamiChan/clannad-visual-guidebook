...
hdft["header"]=Header("nagisa","古河 渚/幸村 俊夫","Nagisa Furukawa / Toshio Yukimura","3对3篮球赛(一)","3 on 3 Basketball Match - Part1");
...
CmtSelect="";
CmtCaution="";
CmtOption="+在新校舍寻找</div></td><td width=\""+(COMMENTBARWIDTH)+"\" height=\""+COMMENTBARHEIGHT+"\" valign=\"bottom\" background=\""+src_commentbase_option_B+"\" align=\"center\"><div class=\"cmtopt"+sizestr+"\">去二楼寻找</div></td><td width=\""+(COMMENTBARWIDTH)+"\" height=\""+COMMENTBARHEIGHT+"\" valign=\"bottom\" align=\"center\"></td><td width=\""+(COMMENTBASESPACING)+"\"></td></tr></table></td></tr><tr><td background=\""+src_commentbase_base+"\"><table border=0 cellpadding=0 cellspacing=0 width=\""+COMMENTWIDTH+"\"><tr><td width=\""+(COMMENTBASESPACING)+"\"></td><td width=\""+(8*COMMENTBUTTONSIZE-COMMENTBASESPACING)+"\" height=\""+COMMENTBUTTONSIZE+"\" valign=\"bottom\" align=\"left\" class=\"comment"+sizestr+"\"><img src=\""+src_comment_mark_un[0]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[1]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[2]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[3]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[4]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[5]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_un[6]+"\" style=\"margin-right:0px;\"><img src=\""+src_comment_mark_en[7]+"\" style=\"margin-right:0px;\"></td><td width=\""+(COMMENTWIDTH-COMMENTBASESPACING-8*COMMENTBUTTONSIZE)+"\"><table border=0 cellpadding=0 cellspacing=0 height="+COMMENTEVENTHEIGHT+" background=\""+src_commentbase_event+"\"><tr><td height="+COMMENTEVENTHEIGHT+" valign=\"middle\" class=\"cmtEvnt"+sizestr+"\" width=\""+(COMMENTWIDTH-2*COMMENTBASESPACING-8*COMMENTBUTTONSIZE)+"\">智代有条件参与毕业典礼</td></tr></table></td><td width=\""+(COMMENTBASESPACING)+"\"></td></tr></table></td></tr><tr><td background=\""+src_commentbase_base+"\" height=\""+(COMMENTBASESPACING/2)+"\"></td></tr><tr><td background=\""+src_commentbase_base+"\"><table border=0 cellpadding=0 cellspacing=0 width=\""+COMMENTWIDTH+"\"><tr><td width=\""+(COMMENTBASESPACING)+"\"></td><td width=\""+(COMMENTBARWIDTH)+"\" height=\""+COMMENTBARHEIGHT+"\" background=\""+src_commentbase_option_A+"\" valign=\"bottom\" align=\"center\"><div class=\"cmtopt"+sizestr+"\">在旧校舍寻找|-去资料室找找";
CmtEvents="00000001";
CmtEvntIru="美佐枝有条件参与毕业典礼。如果26日在分支前来探亲的芽衣选择好的，则美佐枝已确定出席毕业典礼，此处的选择没有影响";
box[0][1]=Textbox_Selection_C(x(3),y(yLevel),"寻找范围的确定（一）","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"寻找范围的确定",0);
...
CmtSummery="";
CmtSelect="{已经来过新校舍二楼}即今日在3对3篮球赛（一）中触发过分支{寻找范围的确定（二）}并且选择了[去二楼寻找]。分支{寻找范围的确定（二）和（三）}的四个选项[去二楼寻找]、[去三楼寻找]、[去空教室找找]、[去资料室找找]只有第一次选择时才会发生剧情。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[5][1]=Textbox_Condition_C(x(5),y(yLevel),"已经来过新校舍二楼","2",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"已经来过新校舍二楼",0);
...
CmtEvents="00000001";
CmtEvntIru="智代参与毕业典礼";
box[9][0]=Textbox_Selection_C(x(3),y(yLevel),"考虑邀请智代","3",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"考虑邀请智代",0);
...
yLevel+=3;
CmtSummery="";
CmtSelect="再次进入3对3篮球赛（一），即跳回到28日分支{寻找范围的确定（一）}。接下来的{3对3篮球赛（一）}同样是这个意思。";
CmtCaution="";
CmtOption="";
CmtEvents="";
CmtEvntIru="";
box[14][0]=Textbox_Option_C(x(5),y(yLevel),"3对3篮球赛（一）","4",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"3对3篮球赛（一）",0);
