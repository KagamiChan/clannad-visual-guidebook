...
hdft["header"]=Header("kotomi","一之濑 琴美","Kotomi Ichinose","4月20日～4月23日","April 20th~April 23rd");
...
box[1][0]=Textbox_Selection_C(x(3),y(yLevel),"读书的邀请","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"读书的邀请",0);
...
CmtEvents="00000100";
CmtEvntIru="琴美好感度上升1点";
box[15][0]=Textbox_Selection_C(x(3.5),y(yLevel),"介意的琴美","1",CmtSummery,CmtSelect,CmtCaution,CmtOption,CmtEvents,CmtEvntIru,"介意的琴美",0);
